...
class Main:
    def __init__(self) -> None:
        ...
        self.creditList = [
            ...
            self.my_font.render(
                "Créateur de souvenirs : Arnaud Chadal (c moi)", True, (255, 255, 255)
            ),
            self.my_font.render(
        ...
        self.splashTextList = [
            ...
            self.my_font.render(
                "Qui pisse au vent se rince les dents - Mathis", True, (255, 255, 255)
            ),
            self.my_font.render(
                "FLOOOOOOORRRRIIIIIAAAANNN - Alexis", True, (255, 255, 255)
            ),
        ...
        self.createBlankButton = button.Button(710, 500, 500, 80)

        self.loadButton = button.Button(710, 600, 500, 80)
        self.buttonList = [
